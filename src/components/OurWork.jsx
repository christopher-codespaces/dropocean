...
export const OurWork = () => {
  return (
    <section className="mt-20 relative grid min-h-screen w-full place-content-center overflow-hidden bg-neutral-950">
...
const Card = ({ containerRef, src, alt, top, left, rotate, className }) => {
  ...
  return (
    <motion.img
      ...
      className={twMerge(
        "drag-elements absolute w-full bg-neutral-200 p-1 pb-4",
        className
      )}
      src={src}
      alt={alt}
